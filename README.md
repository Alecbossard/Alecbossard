...
| 🏎️ **[Path Planning Simulation](https://github.com/Alecbossard/PathPlanning)** | Autonomous racing trajectory planner: cone-based tracks, RRT* + QP racing line, real-time 3D simulation | TypeScript, React, Vite, RRT* |
