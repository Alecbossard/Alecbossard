...
| 🏎️ **[Path Planning Simulation](https://github.com/Alecbossard/PathPlanning)** | Navigation algorithm for autonomous racing: centerline extraction, greedy path sorting, and **B-Spline** smoothing. | Python, NumPy, SciPy, Pygame |
